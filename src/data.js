...
// 産業テーマ（24）。公開情報に基づく調査領域。日本語のみで表示。
export const THEMES = [
  '半導体',
  'AI',
  '防衛',
...
export const WHY_JAPAN = [
  {
    ja: '資本効率とガバナンス改革',
    desc: '東証の資本効率改善要請やガバナンス改革を背景に、上場企業の資本政策や市場からの見られ方が変わりつつあります。金融庁の資産運用立国やNISA拡充により、国内の預貯金が資本市場へ向かう流れも政策的に進められています。',
  },
  {
    ja: '円安が変える相対価格',
    desc: '円安により、日本企業や日本の技術・資産の相対的な見え方が変わっています。海外から見る日本市場の評価軸にも影響を与えています。',
  },
  {
    ja: '事業承継の大波',
    desc: 'オーナー経営者世代の高齢化により、長年黒字を続けてきた地方・非上場企業にも承継や再編の波が広がっています。',
  },
  {
    ja: '英語圏が見落としている技術の深度',
    desc: '地方・非上場企業が素材、部品、精密加工で持つ優位性は、英語情報だけでは見えにくい領域です。',
  },
]
